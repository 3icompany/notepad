  ...
  (function ($, window, document, undefined) {
    ...
    $(function () {
      ...
      $("#logout").on("click", function () {
        ...
        fetch(
          `https://dieuhanh.vatco.vn/MobileLogin/LogOutNodeJs?userName=${$("#username")[0].value
          }`,
          requestOptions
        )
          .then((response) => response.json())
      ...
      $("#join_meeting").on("click", function () {
        ...
        fetch(
          `https://dieuhanh.vatco.vn/MobileLogin/GetListMeetingSchedule?UserName=${$("#username")[0].value
